define(['module', 'require', 'exports', './workerHelpers-df704e42'], function (module, require, exports, workerHelpers) { 'use strict';
    ...
    */
    ...
    async function init(input, maybe_memory) {
        if (typeof input === 'undefined') {
            input = new URL("/c/squoosh_oxipng_bg-89ef9006.wasm", module.uri);
        }
        const imports = {};
        imports.wbg = {};
